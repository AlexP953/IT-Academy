...
$strings = ['1','22','333','4444','55555', '666666', '7777777', '88888888', '999999999'];

// Le paso un array de strings. Primero calcula la longitud de cada string y, si es par, la devuelve.
function evenCharacter(array $stringsArray):array {
  return array_filter($stringsArray, function($e) {
    return !(strlen($e) & 1);
  });
}

print_r(evenCharacter($strings));
...
function totalOfIntegersNumbers(array $integersArray){
  $total = array_reduce($integersArray, function($total, $e){

    //Las condiciones para encontrar numeros primos: Mayor o igual que 1, impar, que no sea multiple de 3 y puedan ser 2 y 3

    if($e >= 2 && ($e % 2 != 0 && $e % 3 != 0) || $e === 2 || $e === 3 ){
      $total += $e;
    }
    return $total;
  },0);
...
echo totalOfIntegersNumbers($numbers)
